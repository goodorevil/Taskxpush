...
export const ScanningModal: React.FC<ScanningModalProps> = ({ progress }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs animate-in fade-in">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-orange-50 text-[#C2542D]">
        ...
        <div className="space-y-1.5 mb-5">
          ...
          <div className="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
            <div
              className="h-full bg-[#C2542D] transition-all duration-300 ease-out"
              style={{ width: `${percent}%` }}
            />
          </div>
        </div>
        ...
        <p className="text-[11px] text-slate-400 text-center leading-relaxed">
          Gemini extracts action items into categories with zero permanent storage of raw email text.
        </p>
      </div>
    </div>
  );
